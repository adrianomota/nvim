...
elixir.setup({
  ...
  on_attach = function(client, bufnr)
    ...
    vim.keymap.set("n", "<A-f>", "<cmd>lua vim.lsp.buf.formatting_seq_sync()<cr>", map_opts)
    vim.keymap.set("n", "gd", "<cmd>lua vim.diagnostic.open_float()<cr>", map_opts)
    vim.keymap.set("n", "<A-d>", "<cmd>lua vim.lsp.buf.definition()<cr>", map_opts)
    vim.keymap.set("n", "K", "<cmd>lua vim.lsp.buf.hover()<cr>", map_opts)
    vim.keymap.set("n", "<A-i>","<cmd>lua vim.lsp.buf.implementation()<cr>", map_opts)
